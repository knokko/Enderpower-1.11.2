...
public class WorldGenNetherOres extends WorldGenerator
{
    ...
    public WorldGenNetherOres(IBlockState state, int blockCount)
    {
        this(state, blockCount, new WorldGenNetherOres.NetherRackPredicate());
    }

    public WorldGenNetherOres(IBlockState state, int blockCount, Predicate<IBlockState> p_i45631_3_)
    {
        this.oreBlock = state;
