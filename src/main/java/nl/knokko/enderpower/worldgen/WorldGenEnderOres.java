...
public class WorldGenEnderOres extends WorldGenerator
{
    ...
    public WorldGenEnderOres(IBlockState state, int blockCount)
    {
        this(state, blockCount, new WorldGenEnderOres.NetherRackPredicate());
    }

    public WorldGenEnderOres(IBlockState state, int blockCount, Predicate<IBlockState> p_i45631_3_)
    {
        this.oreBlock = state;
